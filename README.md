...
```bash
git clone https://github.com/NikGaykwad/Full-stack-Chat-app.git
```
...
If you are using KIND or MiniKube
kubectl port-forward svc/<frontend-service-name> 80:80 -n <namespace>
